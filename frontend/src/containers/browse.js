...
export default function BrowseContainer({ slides }) {
  ...
  return profile.displayName ? (
    <>
      ...
      <Header src="joker1" bg={loading ? false : true} dontShowOnSmallViewPort>
        <Header.Frame>
          <Header.Group>
        ...
        <Header.Feature>
          <Header.FeatureCallOut>Watch The Jocker Now</Header.FeatureCallOut>
          <Header.Text>
            ...
            {slideRows.map(slideItem => (
                <Card key={`${category} -- ${slideItem.title.toLowerCase()}`}>
                    ...
                    <Card.Feature category={category}>
                        <Player>
                            <Player.Button/>
                            <Player.Video src={'/videos/Sidetalk.mp4'}/>
                        </Player>
                    </Card.Feature>
                </Card>
            ))}
